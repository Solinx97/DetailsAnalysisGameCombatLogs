...
IF OBJECT_ID(N'[AuthorizationCodeChallenge]') IS NULL
BEGIN
...
IF OBJECT_ID(N'[IdentityUser]') IS NULL
BEGIN
...
IF OBJECT_ID(N'[RefreshToken]') IS NULL
BEGIN
...
IF OBJECT_ID(N'[ResetToken]') IS NULL
BEGIN
...
IF OBJECT_ID(N'[VerifyEmailToken]') IS NULL
BEGIN
