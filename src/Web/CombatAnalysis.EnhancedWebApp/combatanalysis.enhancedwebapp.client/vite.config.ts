...
const gameLogsEnpoints = (target: string, apiVersion: string) => {
    return {
        ...
        [`^/api/${apiVersion}/Dashboard`]: { target, secure: false },
        [`^/api/${apiVersion}/BossMap`]: { target, secure: false },
        [`^/api/${apiVersion}/Unit`]: { target, secure: false },
        [`^/api/${apiVersion}/UnitCast`]: { target, secure: false },
        [`^/api/${apiVersion}/UnitHealth`]: { target, secure: false },
        [`^/api/${apiVersion}/UnitPosition`]: { target, secure: false },
        [`^/api/${apiVersion}/UnitAura`]: { target, secure: false },
        [`^/api/${apiVersion}/UnitPreAura`]: { target, secure: false },
