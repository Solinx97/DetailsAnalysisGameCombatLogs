...
public class GroupChatUserController : ControllerBase
{
    ...
    {
        var result = await _service.GetByParamAsync(nameof(GroupChatUserModel.ChatId), chatId);
    ...
    {
        var chatUsers = await _service.GetByParamAsync(nameof(GroupChatUserModel.ChatId), chatId);
