...
namespace CombatAnalysis.UploadingLogsApp.Security;

internal class SecurityStorage : ISecurityStorage
{
    ...
    private readonly ILogger<SecurityStorage> _logger;
    ...
    public SecurityStorage(IMemoryCache memoryCache, IHttpClientHelper httpClient, ILogger<SecurityStorage> logger)
    {
