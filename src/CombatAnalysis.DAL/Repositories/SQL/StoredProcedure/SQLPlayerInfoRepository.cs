...
public class SQLPlayerInfoRepository<TModel, TIdType> : ISQLPlayerInfoRepository<TModel, TIdType>
    where TModel : class
    where TIdType : notnull
{
    ...
    public async Task<IEnumerable<TModel>> GetByCombatPlayerIdAsync(TIdType combatPlayerId)
    {
        var data = await _context.Set<TModel>()
