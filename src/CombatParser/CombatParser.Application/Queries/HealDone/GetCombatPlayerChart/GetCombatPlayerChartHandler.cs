...
internal class GetCombatPlayerChartHandler(IChartRepository<Domain.Entities.CombatPlayerData.HealDone> repository, IMapper mapper) : IRequestHandler<GetCombatPlayerChartQuery, IEnumerable<ChartGenericDto>>
{
