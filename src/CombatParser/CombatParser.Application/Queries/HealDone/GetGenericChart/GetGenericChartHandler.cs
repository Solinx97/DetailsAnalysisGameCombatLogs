...
internal class GetGenericChartHandler(IChartRepository<Domain.Entities.CombatPlayerData.HealDone> repository, IMapper mapper) : IRequestHandler<GetGenericChartQuery, Dictionary<string, ChartGenericDto[]>>
{
