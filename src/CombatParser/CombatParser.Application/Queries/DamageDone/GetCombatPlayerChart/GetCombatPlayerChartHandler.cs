...
internal class GetCombatPlayerChartHandler(IChartRepository<Domain.Entities.CombatPlayerData.DamageDone> repository, IMapper mapper) : IRequestHandler<GetCombatPlayerChartQuery, IEnumerable<ChartGenericDto>>
{
