...
internal class GetChartHandler(IChartRepository<Domain.Entities.CombatPlayerData.DamageTaken> repository, IMapper mapper) : IRequestHandler<GetChartQuery, IEnumerable<ChartGenericDto>>
{
