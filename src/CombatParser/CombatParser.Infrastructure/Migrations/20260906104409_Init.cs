        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 85, 1, 14, 3379, 560000000L, "Нимрисса Волногон", 30 },
                    { 86, 1, 15, 3379, 683000000L, "Нимрисса Волногон", 30 },
                    { 87, 1, 14, 3470, 346000000L, "Нек'зали Душительница Душ", 30 },
                    { 88, 1, 15, 3470, 652000000L, "Нек'зали Душительница Душ", 30 },
                    { 89, 1, 14, 3497, 1010000000L, "Потерявшиеся исследователи", 30 },
                    { 90, 1, 15, 3497, 1484000000L, "Потерявшиеся исследователи", 30 },
                    { 91, 1, 14, 3420, 556000000L, "Ссзорак", 30 },
                    { 92, 1, 15, 3420, 898000000L, "Ссзорак", 30 },
                    { 93, 1, 14, 3445, 440000000L, "Погребенные стражи", 30 },
                    { 94, 1, 15, 3445, 790000000L, "Погребенные стражи", 30 },
                    { 95, 1, 14, 3455, 562000000L, "Вашник Тлетворный", 30 },
                    { 96, 1, 15, 3455, 962000000L, "Вашник Тлетворный", 30 },
                    { 97, 1, 14, 3421, 798000000L, "Два Клыка", 30 },
                    { 98, 1, 15, 3421, 1408000000L, "Два Клыка", 30 },
                    { 99, 1, 14, 3429, 403000000L, "Спиральный алтарь", 30 },
                    { 100, 1, 15, 3429, 548000000L, "Спиральный алтарь", 30 },
                    { 101, 1, 14, 3492, 714000000L, "Ула'тек", 30 },
                    { 102, 1, 15, 3492, 1550000000L, "Ула'тек", 30 }
                });
