    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CombatPlayer_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DamageDone_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ResourceRecovery_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitAura", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitAura_Unit_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Unit",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UnitAura_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetGameId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UnitHealth_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UnitPosition_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitPreAura", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitPreAura_Unit_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Unit",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UnitPreAura_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "BossMap",
                columns: new[] { "Id", "GameId", "Name", "X0", "X1", "Y0", "Y1", "Zoom" },
                values: new object[,]
                {
                    { 1, 556, "Осада Оргриммара", 1000.0, 550.0, 1600.0, 500.0, 5 },
                    { 2, 557, "Осада Оргриммара", 1325.0, 1000.0, 1450.0, 150.0, 5 },
                    { 3, 558, "Осада Оргриммара", 700.0, 525.0, 1350.0, 600.0, 5 },
                    { 4, 559, "Осада Оргриммара", 1250.0, 900.0, -4530.0, -5160.0, 5 },
                    { 5, 560, "Осада Оргриммара", 1525.0, 1300.0, -3800.0, -5000.0, 5 },
                    { 6, 562, "Осада Оргриммара", 1560.0, 1500.0, -4430.0, -4850.0, 5 },
                    { 7, 563, "Осада Оргриммара", 1800.0, 1575.0, -4425.0, -5467.0, 5 },
                    { 8, 564, "Осада Оргриммара", 1450.0, 1060.0, -4555.0, -5700.0, 5 },
                    { 9, 565, "Осада Оргриммара", 1900.0, 1720.0, -5370.0, -5875.0, 5 },
                    { 10, 566, "Осада Оргриммара", 1465.0, 1200.0, -5375.0, -5967.0, 5 },
                    { 11, 567, "Осада Оргриммара", 1035.0, 960.0, -5400.0, -5867.0, 5 },
                    { 12, 558, "Осада Оргриммара", 665.0, 500.0, 1575.0, 675.0, 5 },
                    { 13, 559, "Осада Оргриммара", 1150.0, 800.0, -3980.0, -4900.0, 5 },
                    { 14, 564, "Осада Оргриммара", 1200.0, 1060.0, -4470.0, -5700.0, 5 },
                    { 15, 2632, "Приливный грот", 4715.0, 4600.0, -11850.0, -12320.0, 3 },
                    { 16, 2606, "Осада Оргриммара", 150.0, 0.0, 476.0, -476.0, 5 },
                    { 17, 2609, "Осада Оргриммара", 460.0, 0.0, 950.0, 0.0, 5 },
                    { 18, 2609, "Осада Оргриммара", 250.0, 0.0, 850.0, 0.0, 5 },
                    { 19, 2608, "Осада Оргриммара", 450.0, 0.0, 0.0, -725.0, 5 },
                    { 20, 2608, "Осада Оргриммара", 290.0, 0.0, 0.0, -625.0, 5 },
                    { 21, 2607, "Осада Оргриммара", 440.0, 0.0, 100.0, -100.0, 1 },
                    { 22, 2610, "Осада Оргриммара", 1090.0, 1000.0, 580.0, -550.0, 10 },
                    { 23, 2610, "Отравленная бездна", 1380.0, 1000.0, 550.0, -550.0, 5 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Boss",
                columns: new[] { "Id", "BossMapId", "Difficult", "GameId", "Name", "Size" },
                values: new object[,]
                {
                    { 1, 1, 3, 1395, "Каменные стражи", 10 },
                    { 2, 1, 5, 1395, "Каменные стражи", 10 },
                    { 3, 1, 3, 1390, "Фэн Проклятый", 10 },
                    { 4, 1, 5, 1390, "Фэн Проклятый", 10 },
                    { 5, 1, 3, 1434, "Душелов Гара'джал", 10 },
                    { 6, 1, 5, 1434, "Душелов Гара'джал", 10 },
                    { 7, 1, 3, 1436, "Призрачные короли", 10 },
                    { 8, 1, 5, 1436, "Призрачные короли", 10 },
                    { 9, 1, 3, 1500, "Элегон", 10 },
                    { 10, 1, 5, 1500, "Элегон", 10 },
                    { 11, 1, 3, 1407, "Воля императора", 10 },
                    { 12, 1, 5, 1407, "Воля императора", 10 },
                    { 13, 1, 3, 1409, "Вечные защитники", 10 },
                    { 14, 1, 5, 1409, "Вечные защитники", 10 },
                    { 15, 1, 3, 1505, "Цулон", 10 },
                    { 16, 1, 5, 1505, "Цулон", 10 },
                    { 17, 1, 3, 1506, "Лэй Ши", 10 },
                    { 18, 1, 5, 1506, "Лэй Ши", 10 },
                    { 19, 1, 3, 1431, "Ша Страха", 10 },
                    { 20, 1, 5, 1431, "Ша Страха", 10 },
                    { 21, 1, 3, 1507, "Императорский визирь Зор'лок", 10 },
                    { 22, 1, 5, 1507, "Императорский визирь Зор'лок", 10 },
                    { 23, 1, 3, 1504, "Повелитель клинков Та'як", 10 },
                    { 24, 1, 5, 1504, "Повелитель клинков Та'як", 10 },
                    { 25, 1, 3, 1463, "Гаралон", 10 },
                    { 26, 1, 5, 1463, "Гаралон", 10 },
                    { 27, 1, 3, 1498, "Повелитель ветров Мел'джарак", 10 },
                    { 28, 1, 5, 1498, "Повелитель ветров Мел'джарак", 10 },
                    { 29, 1, 3, 1499, "Ваятель янтаря Ун'сок", 10 },
                    { 30, 1, 5, 1499, "Ваятель янтаря Ун'сок", 10 },
                    { 31, 1, 3, 1501, "Великая императрица Шек'зир", 10 },
                    { 32, 1, 5, 1501, "Великая императрица Шек'зир", 10 },
                    { 33, 1, 3, 1577, "Джин'рок Разрушитель", 10 },
                    { 34, 1, 5, 1577, "Джин'рок Разрушитель", 10 },
                    { 35, 1, 3, 1575, "Хорридон", 10 },
                    { 36, 1, 5, 1575, "Хорридон", 10 },
                    { 37, 1, 3, 1570, "Совет старейшин", 10 },
                    { 38, 1, 5, 1570, "Совет старейшин", 10 },
                    { 39, 1, 3, 1565, "Тортос", 10 },
                    { 40, 1, 5, 1565, "Тортос", 10 },
                    { 41, 1, 3, 1578, "Мегера", 10 },
                    { 42, 1, 5, 1578, "Мегера", 10 },
                    { 43, 1, 3, 1573, "Цзи-Кунь", 10 },
                    { 44, 1, 5, 1573, "Цзи-Кунь", 10 },
                    { 45, 1, 3, 1572, "Дуруму Позабытый", 10 },
                    { 46, 1, 5, 1572, "Дуруму Позабытый", 10 },
                    { 47, 1, 3, 1574, "Изначалий", 10 },
                    { 48, 1, 5, 1574, "Изначалий", 10 },
                    { 49, 1, 3, 1576, "Темный Анимус", 10 },
                    { 50, 1, 5, 1576, "Темный Анимус", 10 },
                    { 51, 1, 3, 1559, "Кон Железный", 10 },
                    { 52, 1, 5, 1559, "Кон Железный", 10 },
                    { 53, 1, 3, 1560, "Небесные сестры", 10 },
                    { 54, 1, 5, 1560, "Небесные сестры", 10 },
                    { 55, 1, 3, 1579, "Лэй Шэнь", 10 },
                    { 56, 1, 5, 1579, "Лэй Шэнь", 10 },
                    { 57, 2, 3, 1602, "Глубиний", 10 },
                    { 58, 2, 5, 1602, "Глубиний", 10 },
                    { 59, 1, 3, 1598, "Павшие защитники", 10 },
                    { 60, 1, 5, 1598, "Павшие защитники", 10 },
                    { 61, 3, 3, 1624, "Норусхен", 10 },
                    { 62, 3, 5, 1624, "Норусхен", 10 },
                    { 63, 12, 3, 1604, "Ша Гордыни", 10 },
                    { 64, 12, 5, 1604, "Ша Гордыни", 10 },
                    { 65, 4, 3, 1622, "Галакрас", 10 },
                    { 66, 4, 5, 1622, "Галакрас", 10 },
                    { 67, 13, 3, 1600, "Железный исполин", 10 },
                    { 68, 13, 5, 1600, "Железный исполин", 10 },
                    { 69, 5, 3, 1606, "Кор'кронские темные шаманы", 10 },
                    { 70, 5, 5, 1606, "Кор'кронские темные шаманы", 10 },
                    { 71, 6, 3, 1603, "Генерал Назгрим", 10 },
                    { 72, 6, 5, 1603, "Генерал Назгрим", 10 },
                    { 73, 7, 3, 1595, "Малкорок", 10 },
                    { 74, 7, 5, 1595, "Малкорок", 10 },
                    { 75, 8, 3, 1594, "Пандарийские трофеи", 10 },
                    { 76, 8, 5, 1594, "Пандарийские трофеи", 10 },
                    { 77, 14, 3, 1599, "Ток Кровожадный", 10 },
                    { 78, 14, 5, 1599, "Ток Кровожадный", 10 },
                    { 79, 9, 3, 1601, "Мастер осады Черноплавс", 10 },
                    { 80, 9, 5, 1601, "Мастер осады Черноплавс", 10 },
                    { 81, 10, 3, 1593, "Идеалы клакси", 10 },
                    { 82, 10, 5, 1593, "Идеалы клакси", 10 },
                    { 83, 11, 3, 1623, "Гаррош Адский Крик", 10 },
                    { 84, 11, 5, 1623, "Гаррош Адский Крик", 10 },
                    { 85, 15, 14, 3379, "Нимрисса Волногон", 30 },
                    { 86, 15, 15, 3379, "Нимрисса Волногон", 30 },
                    { 87, 16, 14, 3470, "Нек'зали Душительница Душ", 30 },
                    { 88, 16, 15, 3470, "Нек'зали Душительница Душ", 30 },
                    { 89, 17, 14, 3497, "Потерявшиеся исследователи", 30 },
                    { 90, 17, 15, 3497, "Потерявшиеся исследователи", 30 },
                    { 91, 18, 14, 3420, "Ссзорак", 30 },
                    { 92, 18, 15, 3420, "Ссзорак", 30 },
                    { 93, 19, 14, 3445, "Погребенные стражи", 30 },
                    { 94, 19, 15, 3445, "Погребенные стражи", 30 },
                    { 95, 20, 14, 3455, "Вашник Тлетворный", 30 },
                    { 96, 20, 15, 3455, "Вашник Тлетворный", 30 },
                    { 97, 21, 14, 3421, "Два Клыка", 30 },
                    { 98, 21, 15, 3421, "Два Клыка", 30 },
                    { 99, 22, 14, 3429, "Спиральный алтарь", 30 },
                    { 100, 22, 15, 3429, "Спиральный алтарь", 30 },
                    { 101, 23, 14, 3492, "Ула'тек", 30 },
                    { 102, 23, 15, 3492, "Ула'тек", 30 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 1988, 100, 0, 0, 8, null },
                    { 1989, 100, 0, 0, 9, null },
                    { 1990, 100, 0, 0, 10, null },
                    { 1991, 100, 0, 0, 11, null },
                    { 1992, 100, 0, 0, 12, null },
                    { 1993, 100, 0, 0, 13, null },
                    { 1994, 100, 0, 0, 14, null },
                    { 1995, 100, 0, 0, 15, null },
                    { 1996, 100, 0, 0, 16, null },
                    { 1997, 100, 0, 0, 17, null },
                    { 1998, 100, 0, 0, 18, null },
                    { 1999, 100, 0, 0, 19, null },
                    { 2000, 100, 0, 0, 20, null },
                    { 2001, 101, 0, 0, 1, null },
                    { 2002, 101, 0, 0, 2, null },
                    { 2003, 101, 0, 0, 3, null },
                    { 2004, 101, 0, 0, 4, null },
                    ...
                    { 2008, 101, 0, 0, 8, null },
                    { 2009, 101, 0, 0, 9, null },
                    { 2010, 101, 0, 0, 10, null },
                    { 2011, 101, 0, 0, 11, null },
                    { 2012, 101, 0, 0, 12, null },
                    { 2013, 101, 0, 0, 13, null },
                    { 2014, 101, 0, 0, 14, null },
                    { 2015, 101, 0, 0, 15, null },
                    { 2016, 101, 0, 0, 16, null },
                    { 2017, 101, 0, 0, 17, null },
                    { 2018, 101, 0, 0, 18, null },
                    { 2019, 101, 0, 0, 19, null },
                    { 2020, 101, 0, 0, 20, null },
                    { 2021, 102, 0, 0, 1, null },
                    { 2022, 102, 0, 0, 2, null },
                    { 2023, 102, 0, 0, 3, null },
                    { 2024, 102, 0, 0, 4, null },
                    ...
                    { 2028, 102, 0, 0, 8, null },
                    { 2029, 102, 0, 0, 9, null },
                    { 2030, 102, 0, 0, 10, null },
                    { 2031, 102, 0, 0, 11, null },
                    { 2032, 102, 0, 0, 12, null },
                    { 2033, 102, 0, 0, 13, null },
                    { 2034, 102, 0, 0, 14, null },
                    { 2035, 102, 0, 0, 15, null },
                    { 2036, 102, 0, 0, 16, null },
                    { 2037, 102, 0, 0, 17, null },
                    { 2038, 102, 0, 0, 18, null },
                    { 2039, 102, 0, 0, 19, null },
                    { 2040, 102, 0, 0, 20, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceRecovery_UnitId",
                table: "ResourceRecovery",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitAura_UnitId",
                table: "UnitAura",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitCast_UnitId",
                table: "UnitCast",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitHealth_UnitId",
                table: "UnitHealth",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitInfo_UnitId",
                table: "UnitInfo",
                column: "UnitId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UnitPosition_UnitId",
                table: "UnitPosition",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitPreAura_TargetId",
                table: "UnitPreAura",
                column: "TargetId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitPreAura_UnitId",
                table: "UnitPreAura",
                column: "UnitId");
