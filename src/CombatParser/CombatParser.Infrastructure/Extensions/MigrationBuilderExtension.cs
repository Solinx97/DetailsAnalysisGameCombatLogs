...
internal static class MigrationBuilderExtension
{
    ...
    public static Boss[] GenerateBosses()
    {
        ...
        [
            ...
            Boss.Create(85, 3379, "Нимрисса Волногон", 560000000, 14, 30, 1),
            Boss.Create(86, 3379, "Нимрисса Волногон", 683000000, 15, 30, 1),

            #endregion

            #region Отправленная бездна

            Boss.Create(87, 3470, "Нек'зали Душительница Душ", 346000000, 14, 30, 1),
            Boss.Create(88, 3470, "Нек'зали Душительница Душ", 652000000, 15, 30, 1),
            Boss.Create(89, 3497, "Потерявшиеся исследователи", 1010000000, 14, 30, 1),
            Boss.Create(90, 3497, "Потерявшиеся исследователи", 1484000000, 15, 30, 1),
            Boss.Create(91, 3420, "Ссзорак", 556000000, 14, 30, 1),
            Boss.Create(92, 3420, "Ссзорак", 898000000, 15, 30, 1),
            Boss.Create(93, 3445, "Погребенные стражи", 440000000, 14, 30, 1),
            Boss.Create(94, 3445, "Погребенные стражи", 790000000, 15, 30, 1),
            Boss.Create(95, 3455, "Вашник Тлетворный", 562000000, 14, 30, 1),
            Boss.Create(96, 3455, "Вашник Тлетворный", 962000000, 15, 30, 1),
            Boss.Create(97, 3421, "Два Клыка", 798000000, 14, 30, 1),
            Boss.Create(98, 3421, "Два Клыка", 1408000000, 15, 30, 1),
            Boss.Create(99, 3429, "Спиральный алтарь", 403000000, 14, 30, 1),
            Boss.Create(100, 3429, "Спиральный алтарь", 548000000, 15, 30, 1),
            Boss.Create(101, 3492, "Ула'тек", 714000000, 14, 30, 1),
            Boss.Create(102, 3492, "Ула'тек", 1550000000, 15, 30, 1)
