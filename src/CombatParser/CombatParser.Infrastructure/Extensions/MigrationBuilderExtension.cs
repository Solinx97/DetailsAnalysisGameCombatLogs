...
internal static class MigrationBuilderExtension
{
    public static BossMap[] GenerateMaps()
    {
        ...
        [
            ...
            BossMap.Create(1, 556, "Осада Оргриммара", 1000, 550, 1600, 500, 5),
            BossMap.Create(2, 557, "Осада Оргриммара", 1325, 1000, 1450, 150, 5),
            BossMap.Create(3, 558, "Осада Оргриммара", 700, 525, 1350, 600, 5),
            BossMap.Create(4, 559, "Осада Оргриммара", 1250, 900, -4530, -5160, 5),
            BossMap.Create(5, 560, "Осада Оргриммара", 1525, 1300, -3800, -5000, 5),
            BossMap.Create(6, 562, "Осада Оргриммара", 1560, 1500, -4430, -4850, 5),
            BossMap.Create(7, 563, "Осада Оргриммара", 1800, 1575, -4425, -5467, 5),
            BossMap.Create(8, 564, "Осада Оргриммара", 1450, 1060, -4555, -5700, 5),
            BossMap.Create(9, 565, "Осада Оргриммара", 1900, 1720, -5370, -5875, 5),
            BossMap.Create(10, 566, "Осада Оргриммара", 1465, 1200, -5375, -5967, 5),
            BossMap.Create(11, 567, "Осада Оргриммара", 1035, 960, -5400, -5867, 5),
            BossMap.Create(12, 558, "Осада Оргриммара", 665, 500, 1575, 675, 5),
            BossMap.Create(13, 559, "Осада Оргриммара", 1150, 800, -3980, -4900, 5),
            BossMap.Create(14, 564, "Осада Оргриммара", 1200, 1060, -4470, -5700, 5),

            #endregion

            #region Приливный грот

            BossMap.Create(15, 2632, "Приливный грот", 4715, 4600, -11850, -12320, 3),

            #endregion

            #region Отравленная бездна

            BossMap.Create(16, 2606, "Осада Оргриммара", 150, 0, 476, -476, 5),
            BossMap.Create(17, 2609, "Осада Оргриммара", 460, 0, 950, 0, 5),
            BossMap.Create(18, 2609, "Осада Оргриммара", 250, 0, 850, 0, 5),
            BossMap.Create(19, 2608, "Осада Оргриммара", 450, 0, 0, -725, 5),
            BossMap.Create(20, 2608, "Осада Оргриммара", 290, 0, 0, -625, 5),
            BossMap.Create(21, 2607, "Осада Оргриммара", 440, 0, 100, -100, 1),
            BossMap.Create(22, 2610, "Осада Оргриммара", 1090, 1000, 580, -550, 10),
            BossMap.Create(23, 2610, "Отравленная бездна", 1380, 1000, 550, -550, 5),
    ...
    public static Boss[] GenerateBosses()
    {
        ...
        [
            ...
            Boss.Create(85, 3379, "Нимрисса Волногон", 14, 30, 15),
            Boss.Create(86, 3379, "Нимрисса Волногон", 15, 30, 15),

            #endregion

            #region Отправленная бездна

            Boss.Create(87, 3470, "Нек'зали Душительница Душ", 14, 30, 16),
            Boss.Create(88, 3470, "Нек'зали Душительница Душ", 15, 30, 16),
            Boss.Create(89, 3497, "Потерявшиеся исследователи", 14, 30, 17),
            Boss.Create(90, 3497, "Потерявшиеся исследователи", 15, 30, 17),
            Boss.Create(91, 3420, "Ссзорак", 14, 30, 18),
            Boss.Create(92, 3420, "Ссзорак", 15, 30, 18),
            Boss.Create(93, 3445, "Погребенные стражи", 14, 30, 19),
            Boss.Create(94, 3445, "Погребенные стражи", 15, 30, 19),
            Boss.Create(95, 3455, "Вашник Тлетворный", 14, 30, 20),
            Boss.Create(96, 3455, "Вашник Тлетворный", 15, 30, 20),
            Boss.Create(97, 3421, "Два Клыка", 14, 30, 21),
            Boss.Create(98, 3421, "Два Клыка", 15, 30, 21),
            Boss.Create(99, 3429, "Спиральный алтарь", 14, 30, 22),
            Boss.Create(100, 3429, "Спиральный алтарь", 15, 30, 22),
            Boss.Create(101, 3492, "Ула'тек", 14, 30, 23),
            Boss.Create(102, 3492, "Ула'тек", 15, 30, 23)
