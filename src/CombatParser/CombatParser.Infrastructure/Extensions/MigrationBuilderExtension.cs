...
internal static class MigrationBuilderExtension
{
    public static BossMap[] GenerateMaps()
    {
        ...
        [
            // Осада Огриммара
            BossMap.Create(1, 556, "Осада Оргриммара", 1310.416992, 806.250000, 1239.583008, 481.250000),
            BossMap.Create(2, 557, "Осада Оргриммара", 1729.171631, 1095.828369, 1150.010010, 199.994995),
            BossMap.Create(3, 558, "Осада Оргриммара", 1000.000000, 625.000000, 1278.750000, 716.250000),
            BossMap.Create(4, 559, "Осада Оргриммара", 1654.516602, 893.403381, -4020.830078, -5162.500000),
            BossMap.Create(5, 560, "Осада Оргриммара", 2125.000000, 1318.750000, -3789.583984, -5000.000000),
            BossMap.Create(6, 562, "Осада Оргриммара", 1900.000000, 1500.000000, -4237.500000, -4837.500000),
            BossMap.Create(7, 563, "Осада Оргриммара", 2165.000000, 1575.000000, -4582.500000, -5467.500000),
            BossMap.Create(8, 564, "Осада Оргриммара", 1865.833374, 1059.166626, -4490.000000, -5700.000000),
            BossMap.Create(9, 565, "Осада Оргриммара", 2157.080078, 1727.079956, -5230.000000, -5875.000000),
            BossMap.Create(10, 566, "Осада Оргриммара", 1790.000000, 1200.000000, -5082.500000, -5967.500000),
            BossMap.Create(11, 567, "Осада Оргриммара", 1275.000000, 960.000000, -5403.750000, -5876.250000),
        ];
    ...
    public static Boss[] GenerateBosses()
    {
        ...
        [
            ...
            Boss.Create(63, 1604, "Ша Гордыни", 426000000, 3, 10, 3),
            Boss.Create(64, 1604, "Ша Гордыни", 661000000, 5, 10, 3),
            Boss.Create(65, 1622, "Галакрас", 139000000, 3, 10, 4),
            Boss.Create(66, 1622, "Галакрас", 218000000, 5, 10, 4),
            Boss.Create(67, 1600, "Железный исполин", 451000000, 3, 10, 4),
            Boss.Create(68, 1600, "Железный исполин", 592000000, 5, 10, 4),
            ...
            Boss.Create(77, 1599, "Ток Кровожадный", 445000000, 3, 10, 8),
            Boss.Create(78, 1599, "Ток Кровожадный", 654000000, 5, 10, 8),
